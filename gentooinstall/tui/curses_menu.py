...
from gentooinstall.tui.help import Help
from gentooinstall.tui.menu_item import MenuItem, MenuItemGroup, MenuItemsState
from gentooinstall.tui.result import Result, ResultType
from gentooinstall.tui.types import (
	SCROLL_INTERVAL,
	STYLE,
	Alignment,
	Chars,
...
class AbstractCurses[ValueT](metaclass=ABCMeta):
	...
	def _set_help_viewport(self) -> Viewport:
		...
		return Viewport(
			...
			frame=FrameProperties.min(tr('gentooinstall help')),
		)
