...
gentooinstall supports multiple languages, which depend on translations coming from the community :)
...
gentooinstall validates this by making sure your passwords are ASCII compatible.
...
After that you're all ready to go and enjoy gentooinstall in the new language :)
