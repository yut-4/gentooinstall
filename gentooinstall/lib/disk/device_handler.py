...
from gentooinstall.lib.exceptions import DiskError, SysCallError, UnknownFilesystemFormat
...
from gentooinstall.lib.models.users import Password
from gentooinstall.lib.output import debug, error, info, log
from gentooinstall.lib.utils.util import is_subpath


class DeviceHandler:
	_TMP_BTRFS_MOUNT = Path('/mnt/gentoo_btrfs')
	...
	def load_devices(self) -> None:
		...
		for device in devices:
			...
			# exclude live-media loop devices
			if dev_lsblk_info.mountpoint in live_iso_mountpoints:
				continue
	...
	def get_btrfs_info(
		...
		if not lsblk_info.mountpoint:
			...
			# "mountpoint": "/mnt/gentooinstall/var/log"
			# "mountpoints": ["/mnt/gentooinstall/var/log", "/mnt/gentooinstall/home", ..]
		...
		# "mountpoints": ["/mnt/gentooinstall/log", "/mnt/gentooinstall/home", "/mnt/gentooinstall", ...]
		# "fsroots": ["/@log", "/@home", "/@"...]
