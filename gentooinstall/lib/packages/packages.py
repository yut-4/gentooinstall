...
from gentooinstall.lib.menu.helpers import Loading, Notify, Selection
from gentooinstall.lib.models.packages import AvailablePackage, LocalPackage, PackageGroup, Repository
...
def list_available_packages(
	...
	try:
		...
		debug(f'Failed to list available packages via package manager: {e}')
		return {}
