...
from gentooinstall.lib.hardware import GfxDriver, SysInfo
from gentooinstall.lib.menu.helpers import Confirmation, Selection
from gentooinstall.lib.models.application import ZramAlgorithm, ZramConfiguration
...
def select_kernel(preset: list[str] = []) -> list[str]:
	...
	:rtype: string
	"""
	kernels = ['gentoo-kernel-bin', 'gentoo-kernel', 'hardened-sources']
