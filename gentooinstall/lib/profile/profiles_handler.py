...
from gentooinstall.lib.networking import fetch_data_from_url
...
class ProfileHandler:
	...
	def parse_profile_config(self, profile_config: ProfileSerialization) -> Profile | None:
		...
		# 	from gentooinstall.default_profiles.custom import CustomTypeProfile
		# 	custom_types = []
		#
		# 	for entry in custom:
		# 		custom_types.append(
		...
		if details:
			for detail in filter(None, details):
				# [2024-04-19] TODO: Backwards compatibility after naming change: https://github.com/gentooinstall/gentooinstall/pull/2421
	...
	def install_gfx_driver(self, install_session: Installer, driver: GfxDriver) -> None:
		...
		if driver in [GfxDriver.NvidiaOpenKernel, GfxDriver.NvidiaProprietary]:
			...
			# Fixes https://github.com/gentooinstall/gentooinstall/issues/585
