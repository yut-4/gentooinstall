...
from gentooinstall.lib.crypt import encrypt
from gentooinstall.lib.menu.helpers import Confirmation, Selection
from gentooinstall.lib.menu.util import get_password, prompt_dir
from gentooinstall.lib.output import debug, logger, warn
...
class ConfigurationOutput:
	def __init__(self, config: InstallerConfig):
		...
		:param config: gentooinstall configuration object
